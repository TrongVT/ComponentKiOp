...
import { Animated, Dimensions, TouchableOpacity, Platform, Text, View } from 'react-native';
...
export default class Header extends Component {
  ...
  render() {
    ...
    const {
      ...
      closedHeaderStyle,
      openedHeaderContent,
      defaultOpenButtonIconColor,
      defaultCloseButtonIconColor,
      title,
      titleStyle,
      defaultOpenButtonIconSize,
      defaultCloseButtonIconSize,
      openButtonPosition,
      closeButtonPosition,
    } = this.props;
    ...
    const openButtonContent = (
      <MAIcon name="menu" size={defaultOpenButtonIconSize} color={defaultOpenButtonIconColor} />
    );
    const closeButtonContent = (
      <MAIcon name="close" size={defaultCloseButtonIconSize} color={defaultCloseButtonIconColor} />
    );
    const openButton = (
      <View
        style={{
        ...
        <Animated.View
          ...
          <View style={{ flex: 1, flexDirection: 'row' }}>
            ...
            <View style={{ flex: 1, backgroundColor: '#fff' }}>
              <View style={{ flexDirection: 'row', height: headerHeight, ...openedHeaderStyle }}>
                {closeButton}
                {openedHeaderContent}
              </View>
              <View style={{ flex: 1 }}>
